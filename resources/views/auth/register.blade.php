                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('sky_id') ? ' has-error' : '' }}">
                            <label for="sky_id" class="col-md-4 control-label">Sky ID</label>

                            <div class="col-md-6">
                                <input id="sky_id" type="text" class="form-control" name="sky_id" value="{{ old('sky_id') }}" required autofocus>

                                @if ($errors->has('sky_id'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('sky_id') }}</strong>
                                    </span>
                                @endif
                            </div>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label" value="{{old('password')}}">Password</label>
